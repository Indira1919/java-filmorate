...
public class FilmControllerTest {
    ...
    void shouldAddFilm() {
        ...
        film4.setDescription("Зима 2006 года. Ощутив необходимость изменить свою жизнь, " +
                "доктор Кейт Форестер покидает свой необычный дом у озера в пригороде Иллинойса и устраивается " +
                "на работу в чикагскую больницу. Единственное, о чем жалеет Кейт, так это о своем красивом доме " +
                "с огромными окнами.");
